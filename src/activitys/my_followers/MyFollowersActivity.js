...
class MyFollowersActivity extends BaseActivity {
    ...
    async componentWillMount() {
        const followers = await api_getFollowers();
        console.log('followers', followers);
        if (followers.data.data && followers.data.data.followers) {
            this.setState({
                userList: followers.data.data.followers || [],
            });
        }
    }
...
export default MyFollowersActivity;

...
import { api_getKey, api_login, api_getTopic, set_navigation, api_allTabs, api_findTabTopic } from '../../api/api';
...
class ClassifyActivity extends BaseActivity {
    ...
    async componentWillMount() {
        try {
            ...
            if (params._id) {
                const topics = await api_findTabTopic(params._id);
                console.log('topics', topics);
                if (topics.data.data.topics) {
                    this.setState({
